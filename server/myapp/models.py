...
class Thing(models.Model):
    ...
    level = models.CharField(max_length=50, blank=True, null=True)  # 竞赛等级
    bmsj = models.CharField(max_length=50, blank=True, null=True)  # 报名时间
    zzf = models.CharField(max_length=50, blank=True, null=True)  # 组织方
    jssj = models.CharField(max_length=50, blank=True, null=True)  # 竞赛时间
    jsdd = models.CharField(max_length=50, blank=True, null=True)  # 竞赛地点
...
class Order(models.Model):
    ...
    receiver_phone = models.CharField(max_length=20, blank=True, null=True)  # 联系电话
    receiver_id = models.CharField(max_length=20, blank=True, null=True)  # 身份证号
    receiver_school = models.CharField(max_length=20, blank=True, null=True)  # 学校
    chengji = models.CharField(max_length=20, blank=True, null=True)  # 成绩
