    ...
    <section class="cart-page flex-view">
      <div class="left-flex">
        <div class="" style="text-align: center;">
          <h2 style="text-align: center;">报名页面</h2>
        </div>
        <div class="" style="text-align: center; background: #ededed;padding: 12px;">
          <div style="width: 300px;text-align: left">赛事名称：{{pageData.title}}</div>
          <div style="width: 300px;text-align: left">竞赛时间：{{pageData.jssj}}</div>
          <div style="width: 300px;text-align: left">竞赛地点：{{pageData.jsdd}}</div>
          <div style="width: 300px;text-align: left">报名时间：{{pageData.bmsj}}</div>
        </div>
        ...
        <input v-model="pageData.receiverId" placeholder="请输入身份证号" class="name" />
        ...
        <input v-model="pageData.receiverSchool" placeholder="请输入您的学校" class="name" />
...
<script setup>
  ...
  onMounted(() => {
    ...
    pageData.level = route.query.level;
    pageData.bmsj = route.query.bmsj;
    pageData.jssj = route.query.jssj;
    pageData.jsdd = route.query.jsdd;
  });
  ...
  const handleCommit = () => {
    ...
    formData.append('receiver_school', pageData.receiverSchool || '');
    formData.append('receiver_id', pageData.receiverId || '');
