        ...
        <div class="order-item-view" v-for="(item, index) in orderData" :key="index">
          ...
          <div class="content flex-view">
            <div class="left-list">
              ...
              <div style="margin-top: 20px;">姓名：{{item.receiver_name}}</div>
              <div>身份证号：{{item.receiver_id}}</div>
              <div>学校：{{item.receiver_school}}</div>
              <div>成绩：{{item.chengji}}</div>
            </div>
          ...
          <div class="bottom flex-view">
            <div class="left">
              ...
              <span class="open" @click="handleDetail(item.thing)">赛事详情</span>
            </div>
