      ...
      <div class="detail-content">
        <div class="detail-content-top">
          ...
          <div class="top-right">
            ...
            <div class="meta">组织方：{{ detailData.zzf }}</div>
            <div class="meta">报名时间：{{ detailData.bmsj }}</div>
            <div class="meta">竞赛时间：{{ detailData.jssj }}</div>
            <div class="meta">竞赛地点：{{ detailData.jsdd }}</div>
            <div class="actions">
                ...
                <div class="things">
                  <div class="thing-item" v-for="item in recommendData" @click="handleDetail(item)">
                    ...
                    <div class="info-view">
                      ...
                      <span class="a-price">{{ item.zzf }}</span>&nbsp;
    ...
    if (userId) {
      ...
      router.push({
        ...
        query: {
          ...
          bmsj: detailData.bmsj,
          jssj: detailData.jssj,
          jsdd: detailData.jsdd
        },
      });
    } else {
      message.warn('请先登录！');
