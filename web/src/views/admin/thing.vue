            ...
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="报名时间">
                  <a-input placeholder="请输入" v-model:value="modal.form.bmsj" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="组织方">
                  <a-input placeholder="请输入" v-model:value="modal.form.zzf" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="竞赛时间">
                  <a-input placeholder="请输入" v-model:value="modal.form.jssj" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="竞赛地点">
                  <a-input placeholder="请输入" v-model:value="modal.form.jsdd" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        formData.append('bmsj', modal.form.bmsj || '');
        formData.append('zzf', modal.form.zzf || '');
        formData.append('jssj', modal.form.jssj || '');
        formData.append('jsdd', modal.form.jsdd || '');
